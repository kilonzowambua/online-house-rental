...
<div class="main-content">
	...
	$ret="select * from request where status='Being processed'";
           ...
           ?>
                                            <tr>
                                               <td><?php echo $row->rdate;?></td>
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                    <a href ="approve.php?rid= <?php echo $row->rid;?>">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Approve request">
