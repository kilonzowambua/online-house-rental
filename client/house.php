...
<div id="wrapper">
		...
		<div class="drop-men" >
		    ...
		    <div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#" class=" hvr-bounce-to-right"><i class="fa fa-home nav_icon"></i> <span class="nav-label">All House</span><span class="fa arrow"></span></a>
       ...
       <div class="content-main">
  		...
  		<!--banner-->	
		    <div class="banner">
				...
				<span>Avaliable rental house</span>
				</h2>
		    </div>
		<!--//banner-->
		<!--content-->
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>All vacant houses<small>Choose here</small></h2>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">House type </th>
                            <th class="column-title">Location </th>
                            <th class="column-title">Amount per month </th>
           ...
           ?>
              ...
              <div class="profile_pic">
                <img src="images/<?php echo $row->image;?>" alt="" class="img-circle profile_img">
                            ...
                            <td class=" "><?php echo $row->housename;?></td>
                            <td class=" "><?php echo $row->housetype;?></td>
                            <td class=" "><?php echo $row->location;?></td>
            
                            <td class=" ">Ksh <?php echo $row->cost;?></td>
                            
                            <td class=" last"><a href='book.php?hid=<?php echo $row->hid;?>' onClick= "return ('Waiti for approval');"><button class="btn btn-danger btn-xs">View</button></a>
                            </td>
                          </tr>
	...
	<!--//gallery-->
		<!---->
<div class="copy">
            <p> &copy; 2019 e-house rental. All Rights Reserved | Design by <a href="http://kilonzowambua.github.io/" target="_blank">Kilodev</a> </p>	    </div>
		</div>
		</div>
		<div class="clearfix"> </div>
       </div>
